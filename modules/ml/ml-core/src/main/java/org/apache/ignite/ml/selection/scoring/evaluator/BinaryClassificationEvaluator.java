...
//     * @return Computed metric.
//     */
//    public static <L, K, V> double evaluate(IgniteCache<K, V> dataCache, SerializableBiPredicate<K, V> filter,
//        IgniteModel<Vector, L> mdl,
//        IgniteBiFunction<K, V, Vector> featureExtractor,
//        IgniteBiFunction<K, V, L> lbExtractor,
//        Metric<L> metric) {
...
//    }
     ...
     * @return Computed metric.
     */
    public static <L, K, V> double evaluate(Map<K, V> dataCache, SerializableBiPredicate<K, V> filter,
        IgniteModel<Vector, L> mdl,
        IgniteBiFunction<K, V, Vector> featureExtractor,
        IgniteBiFunction<K, V, L> lbExtractor,
        Metric<L> metric) {
...
//    }
     ...
     * @return Computed metric.
     */
    public static <K, V> BinaryClassificationMetricValues evaluate(Map<K, V> dataCache, SerializableBiPredicate<K, V> filter,
        IgniteModel<Vector, Double> mdl,
        IgniteBiFunction<K, V, Vector> featureExtractor,
        IgniteBiFunction<K, V, Double> lbExtractor) {
        return calcMetricValues(dataCache, filter, mdl, featureExtractor, lbExtractor);
...
//     * @return Computed metric.
//     */
//    private static <L, K, V> double calculateMetric(IgniteCache<K, V> dataCache, SerializableBiPredicate<K, V> filter,
...
//    }
     ...
     * @return Computed metric.
     */
    private static <L, K, V> double calculateMetric(Map<K, V> dataCache, SerializableBiPredicate<K, V> filter,
        IgniteModel<Vector, L> mdl, IgniteBiFunction<K, V, Vector> featureExtractor,
        IgniteBiFunction<K, V, L> lbExtractor, Metric<L> metric) {
        double metricRes;
