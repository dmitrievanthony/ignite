...
public class MnistMLPTestUtil {
    ...
    /** */
    static BiTuple<Stream<DenseVector>, Stream<DenseVector>> loadMnist(int samplesCnt) throws IOException {
        ...
        return new BiTuple<>(trainingMnistStream, testMnistStream);
    }
